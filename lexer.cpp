...
void lexer() {
    ...
    while(cin.get(ch)) {
        ...
        if (isalpha(ch) || ch=='_') {
            ...
            else if (str=="printf") t.push_back({"PRINTF",str});
            else if (str=="scanf") t.push_back({"SCANF",str});
            ...
            else if (str=="main") t.push_back({"MAIN",str});
            ...
            cin.get();
            t.push_back({"INCREMENT","++"});
        }
        else if (ch=='-' && cin.peek()=='-') {
            cin.get();
            t.push_back({"DECREMENT","--"});
        }
